...
function basic_button($element) {
  ...
  if ($element['#id'] == 'edit-submit' || $element['#id'] == 'edit-reset' || $element['#id'] == 'edit-submit-administrator-page' || $element['#id'] == 'edit-submit-data-management' || $element['#id'] == 'edit-delete') {
    // Now add our custom class
    if (isset($element['#attributes']['class'])) {
      $element['#attributes']['class'] .= ' button grey';
    }
    else {
      $element['#attributes']['class'] = 'button grey sheer';
    }
  }
